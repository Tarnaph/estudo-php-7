...
<div id="staggered-test" class="container">
  <form enctype="multipart/form-data" action="?cadastrar=true" method="post">         
    <div class="row"> 
      <div class="col s12"> 
        <div class="card grey darken-4 hoverable">
         ...
         <!-- Como nós conheceu? -->
          ...
          <!-- Gênero -->
           <div class="row">
            ...
            <label>Sexo:</label> <br><br>
                <input  type="radio" id="sexoM" value="M" name="sexo" checked<?php rtChecked("sexo","M") ?>/>
          ...
          <div class="row">
            <div class="input-field offset-s3 col s6">
              <input id="password" type="password" class="validate" name="senha" <?php rtText("senha") ?>>
          ...
          <div class="row">
            <div class="col s6 right-align">
              <a href="index.php" class="waves-effect waves-light btn grey darken-3 ">
